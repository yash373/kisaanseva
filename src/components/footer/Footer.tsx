...
const Footer = () => {
    return (
        <div className='flex justify-start md:py-0 md:max-h-[10vh] md:min-h-[7vh] py-2 md:space-y-0 space-y-2 md:space-x-7 md:flex-wrap flex-col md:flex-row border-t-4 h-full border-black'>
