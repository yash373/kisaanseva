  ...
  return (
    <div className='flex flex-col space-y-2 w-full'>
      ...
      <div className='flex flex-row space-x-1 flex-wrap justify-evenly items-center'>
        ...
        <Association big={false} img='https://newsd.in/wp-content/uploads/2016/10/maharashtr.jpg' name='Maharashtra Agriculture Helpline Number' desc='022-61316429' link='tel:02261316429' />
      </div>
    </div>
  )
}
